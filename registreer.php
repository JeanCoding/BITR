...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="registreer_bitr.css">
</head>
<body id="body">
<form method="POST">
    <div id="login">
    ...
    <img id="log" src="bitr2.png" alt="Jean logo">
    <h1 id="h2">CREËER EEN ACCOUNT.</h1>

    <label id="label1" for="name"><b>GEBRUIKERSNAAM.</b></label>
    <input id="usern" type="text" placeholder="Gebruikersnaam" name="gebruikersnaam" required>
